...
void hr3mn184(UInt16 (* InpArr)[SZCadr184],UInt16 (* outArr)[SZCadr184]) {
  unsigned int i,j,imax,imax2;
  UInt16 mpair1,mpair2;
  for (j=0; j<SZCDRY184; j++) {
	  mpair1=InpArr[j][1];
	  if(mpair1>InpArr[j][2])
			mpair1=InpArr[j][2];
	  for (i=1; i<SZCDRX184-4; i+=4)   {
		  imax=InpArr[j][i-1];
		  if(imax>mpair1)
				imax=mpair1;
...
void vr3mn184(UInt16 (* InpArr)[SZCadr184],UInt16 (* outArr)[SZCadr184]) {
  unsigned int i,j,imax,imax2;
  UInt16 mpair1,mpair2;
  for (j=0; j<SZCDRY184; j++) {
	  mpair1=InpArr[1][j];
...
void hr5mx184(UInt16 (* InpArr)[SZCadr184],UInt16 (* wrkArr)[SZCadr184], UInt16 (* outArr)[SZCadr184])
{
...
void vr5mx184(UInt16 (* InpArr)[SZCadr184],UInt16 (* wrkArr)[SZCadr184], UInt16 (* outArr)[SZCadr184])
{
//  unsigned int i,j,tmp=0,imax,imax2;
  unsigned int i,j,imax,imax2;
	UInt16 mpair1,mpair2,mpair3;
